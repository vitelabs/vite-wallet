module.exports = {
    ...
    create: {
        ...
        hint: {
            nameInput: 'Please input name????', // [TODO]
            nameLong: '账户不得超出32个字符',   // [TODO]
            long: 'Your input must between 1-32 characters!',
            name: 'Account name is illegal',    // [TODO]
    ...
    accDetail: {
        ...
        password: 'Password',
        hint: {
            token: 'You have got 100 test vite!',   // [TODO]
